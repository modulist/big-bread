 ...
 */
Configure::write( 'Routing.prefixes', array( 'realtor', 'inspector' ) );
 ...
 */
	Configure::write('Security.salt', 'DBhT95b4quJqImfp2xuHoCutWovyiQ2H0RgjC7mu');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '77829608637551582390779285685');
