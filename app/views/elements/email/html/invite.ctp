<p><?php printf( __( 'Hi, and welcome to BigBread.net. %s has completed your home survey and is inviting you to view the savings.', true ), $this->Session->read( 'Auth.User.first_name' ) ) ?></p>
...
<p><?php echo $this->Html->image( 'http://' . env( 'HTTP_HOST' ) . '/img/logo-email.png', array( 'url' => 'http://www.bigbread.net' ) ) ?></p>
