...
<?php echo $this->Form->create( 'Message', array( 'url' => '/feedback' ) ) ?>
  <?php echo $this->Form->input( 'Sender.user_type_id', array( 'type' => 'hidden', 'default' => 'ANONYMOUS' ) ) ?>
  ...
  <?php echo $this->Form->input( 'Sender.user_type_id', array( 'label' => __( 'How would you describe yourself?', true ), 'empty' => 'Select one...' ) ) ?>
