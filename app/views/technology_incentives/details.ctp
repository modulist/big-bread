<div class="modal popup savings-detail">
	<table class="savings-detail-header">
		<tr class="first last">
			<td class="rebate-title"><h2><?php echo h( $rebate['Incentive']['name'] ) ?></h2></td>
  ...
  <div class="detail-buttons clearfix">
	  <?php echo $this->Html->link( __( 'Get a Quote &rsaquo;', true ), array( 'controller' => 'proposals', 'action' => 'request', h( $rebate['TechnologyIncentive']['id'] ), $location_id ), array( 'class' => 'quote-button', 'escape' => false ) ) ?>
