<div class="intro">
  ...
  <?php echo $this->Html->image( 'laptop_hm.png', array( 'width' => 564, 'height' => 416, 'alt' => 'laptop', 'style' => 'float: right;' ) ) ?>
    ...
    <span class="orange">home</span>.</p>
    <p>BigBread.net brings together all the energy efficiency, home improvement rebates that help you 
    lower your home maintenance costs and lower your monthly utility bills.</p>
    <br />
    <p><button>Register now for your rebates!</button></p>
    <p>If you are already registerd, <a href="#">Login</a>.</p>
</div>
...
<div class="introcolumn">
    <h2>Private</h2>
    <p>Respond to personaized offers that work for you</p>
    <p>No phone calls</p>
