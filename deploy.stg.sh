...
if [ -f "app/config/core.$env.php" ]; then
  scp app/config/core.$env.php bigbread:www/__subdomains/stage.bigbread.net/app/config/core.php
else
  scp app/config/core.sample.php bigbread:www/__subdomains/stage.bigbread.net/app/config/core.php
fi
scp app/config/bootstrap.$env.php bigbread:www/__subdomains/stage.bigbread.net/app/config/bootstrap.local.php
scp app/config/database.$env.php bigbread:www/__subdomains/stage.bigbread.net/app/config/database.php
scp app/webroot/.htaccess.$env bigbread:www/__subdomains/stage.bigbread.net/app/webroot/.htaccess
scp app/webroot/robots.$env.txt bigbread:www/__subdomains/stage.bigbread.net/app/webroot/robots.txt

echo "...complete."

# Execute the upgrade.sql file
echo "Running upgrade.sql..."
ssh bigbread "cat www/__subdomains/stage.bigbread.net/app/config/sql/upgrade.sample.sql | sed -e s/@DB_NAME@/bigbread_$env/ > www/__subdomains/stage.bigbread.net/app/config/sql/upgrade.sql"
